...
import OrderDetailPage from "@/features/dealer/manager/page/OrderDetailPage";
import OrderPaymentPage from "@/features/dealer/manager/page/OrderPaymentPage";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<DealerStaffLayout />}>
          ...
          <Route path="/dealer/manager/orders/:id" element={<OrderDetailPage />} />
          <Route path="/dealer/manager/orders/:id/payment" element={<OrderPaymentPage />} />
        </Route>
